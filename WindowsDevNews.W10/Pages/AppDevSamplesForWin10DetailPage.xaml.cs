//---------------------------------------------------------------------------
//
// <copyright file="AppDevSamplesForWin10DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class AppDevSamplesForWin10DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public AppDevSamplesForWin10DetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new AppDevSamplesForWin10Section());
