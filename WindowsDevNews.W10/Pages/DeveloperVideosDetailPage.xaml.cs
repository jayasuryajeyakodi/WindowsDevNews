//---------------------------------------------------------------------------
//
// <copyright file="DeveloperVideosDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DeveloperVideosDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DeveloperVideosDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new DeveloperVideosSection());
