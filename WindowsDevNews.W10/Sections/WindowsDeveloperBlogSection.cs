...
{
    public class WindowsDeveloperBlogSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public WindowsDeveloperBlogSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("https://blogs.windows.com/feed/"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.WindowsDeveloperBlogListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.WindowsDeveloperBlogDetailPage>(true);
                    }
                };
            }
        }
