#pragma checksum "C:\Users\kiranban\Source\Repos\WinDevNews3\WindowsDevNews.W10\Layouts\List\ListBigVerticalCard.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "B2FE615BE47B2D99713958AD9260CABB"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace WindowsDevNews.Layouts.List
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IListBigVerticalCard_Bindings
        {
            ...
            private void Update_(global::WindowsDevNews.ViewModels.ItemViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    ...
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0) | (1 << 1))) != 0)
                    {
                        ...
                        this.Update_SponsoredText(obj.SponsoredText, phase);
                    }
                }
            }
            ...
            private void Update_SponsoredText(global::System.String obj, int phase)
            {
                if((phase & ((1 << 1) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                    ...
                                    bindings.Update_SponsoredText(obj.SponsoredText, DATA_CHANGED);
                            }
                        }
                        else
                        {
